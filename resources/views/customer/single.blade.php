            ...
            <div class="col-sm-12">
                <div class="bg-picture text-center" style="background-image:url('{{ asset("myassets") }}/images/big/bg.jpg')">
                    ...
                    <div class="profile-info-name">
                        <img src="{{ $customer->photo != '' ? url($customer->photo) : url('uploads/customer/man.jpg') }}" class="thumb-lg img-circle img-thumbnail" alt="profile-image">
                            ...
                            <div class="panel panel-default panel-fill">
                                ...
                                <div class="panel-body"> 
                                    ...
                                    <div class="about-info-p m-b-0">
                                        ...
                                        <br/>
                                        <p class="text-muted">{{ $customer->date }}</p>
                                    </div>
                                </div> 
                            </div>
                            <!-- Personal-Information -->
