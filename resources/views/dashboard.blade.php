                                        ...
                                        <div class="inbox-widget nicescroll mx-box">
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ asset('myassets') }}/images/users/avatar-1.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ asset('myassets') }}/images/users/avatar-2.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ asset('myassets') }}/images/users/avatar-4.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ asset('myassets') }}/images/users/avatar-5.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ asset('myassets') }}/images/users/avatar-6.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ asset('myassets') }}/images/users/avatar-8.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="{{ asset('myassets') }}/images/users/avatar-9.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <ul class="conversation-list nicescroll">
                                                <li class="clearfix">
                                                    <div class="chat-avatar">
                                                        <img src="{{ asset('myassets') }}/images/avatar-1.jpg" alt="male">
                                                        <i>10:00</i>
                                                    </div>
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="{{ asset('myassets') }}/images/users/avatar-5.jpg" alt="Female">
                                                        <i>10:01</i>
                                                    </div>
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="{{ asset('myassets') }}/images/users/avatar-5.jpg" alt="male">
                                                        <i>10:02</i>
                                                    </div>
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
