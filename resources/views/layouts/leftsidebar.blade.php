            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        <div class="pull-left">
                            <img src="{{ asset('myassets') }}/images/users/avatar-1.jpg" alt="" class="thumb-md img-circle">
                        </div>
                        <div class="user-info">
                            <div class="dropdown">
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="email-read.html">Employee Reports</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="email-read.html">Customer Reports</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="email-read.html">Supplier Reports</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fa  fa-users"></i><span> Salary (EMP)</span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('salaries.index') }}">Pay Salary</a></li>
                                    <li><a href="{{ route('advances.create') }}">Add Advanced</a></li>
                                    <li><a href="{{ route('advances.index') }}">All Advanced</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
