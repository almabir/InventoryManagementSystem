    <head>
        ...
        <!-- sweet alerts -->
        <link href="{{ asset('myassets') }}/assets/sweet-alert/sweet-alert.min.css" rel="stylesheet">
        ...
        <!-- DataTables -->
        <link href="{{ asset('myassets') }}/assets/datatables/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />
