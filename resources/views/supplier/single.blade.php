...
<div class="content">
    ...
    <div class="wraper container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="bg-picture text-center" style="background-image:url('{{ asset("myassets") }}/images/big/bg.jpg')">
                    <div class="bg-picture-overlay"></div>
                    <div class="profile-info-name">
                        <img src="{{ $supplier->photo != '' ? url($supplier->photo) : url('uploads/customer/man.jpg') }}" class="thumb-lg img-circle img-thumbnail" alt="profile-image">
                            ...
                            <div class="panel panel-default panel-fill">
                                ...
                                <div class="panel-body"> 
                                    ...
                                    <div class="about-info-p m-b-0">
                                        ...
                                        <br/>
                                        <p class="text-muted">{{ $supplier->company }}</p>
                                    </div>
                                    <div class="about-info-p m-b-0">
                                    ...
                                    <div class="about-info-p m-b-0">
                                        ...
                                        <br/>
                                        <p class="text-muted">{{ $supplier->date }}</p>
                                    </div>
                                </div> 
                            </div>
                            <!-- Personal-Information -->
